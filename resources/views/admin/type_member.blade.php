...
@section('content')
    ...
    <section class="content">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="info-box ">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Form Type Member</span>
        ...
        <div class="row">
          ...
          <form action="" method="post" id="formTypeMember">
            {{ csrf_field() }}
            {{ method_field('POST') }}
            <input type="hidden" name="type_member_id">
            <div class="box-body">
                <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered table-hover dataTable" id="type_member_table">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Description</th>
